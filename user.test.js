...
describe("User Account", () => {
	...
	beforeAll(async () => {
		...
		"mongodb+srv://m001-student:m001-mongodb-basics@sandbox.7y2c2.mongodb.net/myFirstDatabase?retryWrites=true&w=majority",
			{ 
	...
	test("User login invalid password", async () => {
		const res = await User.login("Sean Huels","Craig64@yahoo.com","zzz")
	...
	test("User login invalid email id", async () => {
		const res = await User.login("Sean Huels","abc@gmail.com","ikcfxf5pg0WKS0A")
